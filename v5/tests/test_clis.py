...
# Subjects under test
import v5.check_config as check_config_module
import v5.run_pilot as run_pilot_module
from v5.scripts import benchmark_pilot as benchmark_module
from v5.src.harness import cost_estimator as cost_estimator_module
from v5.src.pilot import render_report as render_report_module
...
class TestCheckConfigCLI:
    ...
    def test_status_for_cell_red(self, monkeypatch):
        from v5.src.common.config import CellConfig
        cfg = CellConfig(
